...
> **2026-09-23(D-030):** MLX90614 2대는 계획에서 제외됐다(솥 내장 온도센서로 대체). 아래 27/28번 버스와
> TCA9548A B는 당장 쓰지 않는다. 되살릴 경우를 위해 기술은 남겨 둔다.
...
| 15 | GPIO12 후보 | Adafruit Python 드라이버 사용 시 MAX31865 CS (점유·pinmux 확인 후 확정) |
| 24 | SPI0 CS0_N | Adafruit Python 드라이버 사용 시 연결하지 않음 |
