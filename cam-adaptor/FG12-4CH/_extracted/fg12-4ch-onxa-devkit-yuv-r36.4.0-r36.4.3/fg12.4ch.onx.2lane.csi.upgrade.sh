...
sudo cp fzcam_app/usr/local/bin/fzcam_cfg.2lanes /usr/local/bin/fzcam_cfg
...
sudo cp rootfs/boot/tegra234-p3767-camera-p3768-fzcam-fg12-4ch-2lanes.dtbo /boot/
sudo /opt/nvidia/jetson-io/config-by-hardware.py -n 2="Camera FG12-4CH-2Lanes-YUV"
