...
- auto: 실기기 어댑터(V4L2·Orbbec) + 미지원 항목(MLX) + 요청 시 모의 센서 추가 가능
- real: 실기기·미지원 항목만
"""
...
from .unsupported import Mlx90614Unsupported, Mlx90640Unsupported
...
def build_sensors(settings: Settings) -> list[SensorAdapter]:
    ...
    sensors += [OrbbecGemini2(settings.orbbec_serial), Mlx90640Unsupported(), Mlx90614Unsupported()]
